...
import '../bloc/register_face/register_face_bloc.dart';
              ...
              Padding(
                ...
                child: BlocConsumer<RegisterFaceBloc, RegisterFaceState>(
                  listener: (context, state) {
                    if (state is RegisterFaceFailure) {
                    ...
                    if (state is RegisterFaceLoaded) {
                      AuthLocalDatasource().updateAuthData(state.user);
                  ...
                  builder: (context, state) {
                    ...
                    return Button.filled(
                      onPressed: () async {
                        final xFile = await convertImageToXFile(croppedFace);
                        context.read<RegisterFaceBloc>().add(OnRegisterFace(
                            image: xFile,
